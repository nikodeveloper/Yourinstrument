...
<div class="hero-unit">
  ...
  <?php
    ...
    $sentencia = "SELECT TAB_FILE, TAB_TITULO , TAB_ARTISTA FROM tbl_tablaturas WHERE TAB_CATEGORIA = 'guitarra'";
        ...
        if ($resultado) {
          ...
          $artista = $fila["TAB_ARTISTA"];
          echo "<a href=" . $ruta . "> Descargar   </a>" . $artista  . "     " . $comentario  . "<br>";
                                                  }
                    }
  ?>
  </div>
